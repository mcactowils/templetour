        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="flex flex-col gap-2">
            <button
              ...
              className="px-6 py-3 bg-warm-coral text-white rounded-lg hover:bg-warm-coral-hover transition-colors disabled:opacity-50 disabled:cursor-not-allowed font-medium"
            >
                  ...
                  <div className="ml-11 mt-4">
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-warm-coral text-white rounded-lg hover:bg-warm-coral-hover transition-colors disabled:opacity-50 text-sm font-medium"
                      >
                        Reply
                      </button>
                    </div>
