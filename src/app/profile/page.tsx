        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-white text-[#B77D63] shadow-sm hover:bg-[#B77D63] hover:text-white py-3 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#B77D63] disabled:opacity-50 disabled:cursor-not-allowed font-medium"
            >
